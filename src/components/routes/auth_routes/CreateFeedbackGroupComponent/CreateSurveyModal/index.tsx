...
const CreateSurveyModal: React.FC<IFeedbackCreateModalProps> = ({ open, setOpen }) => {
                    ...
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        ...
                        >
                            <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                                <form className=" w-full mt-2" onSubmit={formHook.handleSubmit(onSubmit)}>
                                    <div>
                                        <p className="text-sm font-bold text-black py-2">Create a New Group</p>
                                        <hr className="py-2" />
                                            ...
                                            <div className="w-full max-w-md ">
                                                <Field>
                                                    <Label className="text-xs font-medium text-black">
                                                        Group Name <span className="text-red-400 text-xs">*</span>
                                                    </Label>
                                                    <Input
                                                        className="text-xs"
                                                        ...
                                                        errorMessages={[
                                                            { message: 'Group Name is required', type: 'required' }
                                        ...
                                        <div>
                                            <div className="w-full max-w-md mt-2">
                                                <Field>
                                                    <Label className="text-xs font-medium text-black">
                                                        About Group <span className="text-red-400 text-xs">*</span>
                                                    </Label>
                                                    ...
                                                    <TextareaComponent
                                                        ...
                                                        fieldError={formHook.formState.errors.groupDescription}
                                                        errorMessages={[
