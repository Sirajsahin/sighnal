...
const CreateSurveryComponent = () => {
    ...
    return (
        <div className="mt-14 flex justify-center items-center gap-2 flex-col">
            <p className="text-base text-[#333333]">Let’s add some questions to your survey</p>
            <p className="text-xs text-[#475467]">click the button below to get your survey up and running.</p>
