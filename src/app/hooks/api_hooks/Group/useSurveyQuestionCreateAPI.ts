...
import { ICampaignQuestionDetailsInfo } from "@/components/routes/auth_routes/CreateSurveyStepComponent/AddSurveyQuestionComponent";
...
export const useSurveyQuestionCreateAPI = () => {
  const execute = useCallback(
    async (paramProps: ICampaignQuestionDetailsInfo[]) => {
      try {
