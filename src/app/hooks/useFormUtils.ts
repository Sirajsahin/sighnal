import { IFormFieldErrorMessages, ISelectMenuItemData, ReducedErrorMessages } from '@/components/ui/interface'
import { FieldError, FieldErrorsImpl, Merge } from 'react-hook-form'

type useFormUtilsReturnType = {
    deduceFormFieldErrors: (
        errorMessages: IFormFieldErrorMessages[],
        fieldError: FieldError | Merge<FieldError, FieldErrorsImpl<ISelectMenuItemData>> | null
